...
struct ChatView: View {
    ...
    private var messageComposer: some View {
        MessageComposerView(
            ...
            configurationErrorMessage: viewModel.composer.composerConfigurationErrorMessage,
            contextWindowSnapshot: viewModel.contextWindowSnapshot,
            gitViewModel: gitAvailabilityViewModel,
            modelGroups: viewModel.composer.modelCatalogGroups,
            selectedModelID: viewModel.selectedModelID,
            selectedModelProviderID: viewModel.selectedModelProviderID,
            selectedModelTitle: viewModel.selectedModelTitle,
            workspaceRoots: viewModel.composer.workspaceRoots,
            selectedWorkspacePath: viewModel.selectedWorkspacePath,
            workspaceSuggestions: viewModel.composer.workspaceSuggestions,
            workspaceManagementServer: server,
            personalitySuggestions: viewModel.composer.personalitySuggestions,
            skillSuggestions: viewModel.composer.skillSlashSuggestions,
            agentCommands: viewModel.composer.agentCommands,
            profileOptions: viewModel.composer.profileOptions,
            isSingleProfileMode: viewModel.composer.isSingleProfileMode,
            selectedProfileName: viewModel.composer.selectedProfileName,
            selectedProfileTitle: viewModel.selectedProfileTitle,
            isLoadingModels: viewModel.composer.isLoadingComposerConfiguration,
            selectedReasoningEffort: viewModel.composer.selectedReasoningEffort,
            supportedReasoningEfforts: viewModel.composer.supportedReasoningEfforts,
            showsReasoningControl: viewModel.composer.showsReasoningEffortControl,
            isUpdatingConfiguration: viewModel.composer.isUpdatingComposerConfiguration,
